							...
							<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
								<div class="text-center">
									<button id="" class="btn btn-outline-dark mt-auto"
										onclick="Kakaopay_Ready('${shop4.shopname }', '${shop4.shopprice }')">구매하기</button>
								</div>
							</div>
						</div>
					</div>
